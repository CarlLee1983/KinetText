 ...
 *
 * 依賴:
 * - tests/e2e/setup.ts  (registerE2EHooks, e2eRootDir)
 * - tests/e2e/fixtures.ts (generateMP3, createTestSubDir)
 * - tests/e2e/utils.ts   (fileExistsAndNonEmpty)
...
import type { ConvertOptions } from '../../src/core/services/MP4ConversionService'
