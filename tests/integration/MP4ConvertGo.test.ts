...
import MP4ConvertGoWrapper from '../../src/core/services/MP4ConvertGoWrapper'
import type { MP4ConvertGoRequest } from '../../src/core/services/MP4ConvertGoWrapper'
...
import type { MP4Metadata, MP4ConversionConfig } from '../../src/core/types/audio'
import { resolveGoBinaryPath } from '../../src/config/goBinaryPaths'

const GO_BINARY_PATH = resolveGoBinaryPath('mp4convert')
