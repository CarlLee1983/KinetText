...
import { ErrorCategory } from '../src/core/types/errors'
...
async function testPhase1() {
  ...
  const classifier = require('../src/core/services/ErrorClassifier').ErrorClassifier
  ...
  const BackoffCalculator = require('../src/core/services/BackoffCalculator').BackoffCalculator
